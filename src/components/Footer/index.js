  ...
  return (
    <footer>
      <div id="footer-logo">
        ...
        <div>
          <p>
            ...
            facilisis bibendum massa gravida cras blandit ac, ex dignissim mus
            sem turpis elementum.
          </p>
        </div>
      </div>
      ...
      <div id="footer-contacto">
        ...
        <div>
          <p>
            R. Gago Coutinho, 0, Casa 00. Laranjeiras RJ CEP: 0000-000
            contato@.com.br Tel. +55 82 99999-999
          </p>
        </div>
      </div>
